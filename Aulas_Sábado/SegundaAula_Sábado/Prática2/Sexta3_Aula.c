...
int main(void)
{
    ...
    while((idade_chico > 0 && idade_chico < 100) && (idade_Ze > 0 && idade_Ze < 100))
    {
        if(idade_chico < 0 || idade_Ze < 0){
            printf("Idade inserida, invalida!");
            break;
        }
        break;
    }
    ...
    printf("\nAnos necessarios para Ze: %i",anos_necessarios2);
    return 0;
}